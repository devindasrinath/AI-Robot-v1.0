#!/usr/bin/env bash
# =============================================================================
# convert.sh — Convert GRU behavior policy ONNX -> cvimodel for SG2002 NPU
#
...
echo " Inputs: obs=[1,1,16]  hidden_in=[1,64]"
echo "============================================================"
model_transform.py \
  --model_name  "${MODEL_NAME}" \
  --model_def   "${ONNX}" \
  --input_shapes "[[1,1,16],[1,64]]" \
  --mlir        "${MLIR}"
